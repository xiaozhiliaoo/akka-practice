package org.lili.akka.part5.http;
...
public class HttpServer {
    public static void main(String[] args) {
        ...
        Source<IncomingConnection, CompletionStage<ServerBinding>> bindSource = Http.get(system).bind(ConnectHttp.toHost("localhost", 8089));
